...
#define OS_LOWEST_PRIO          250u   /* Defines the lowest priority that can be assigned ...         */
...
/*These macros are defined so a library builds with these options */
#define OS_TASK_TMR_PRIO 5
#define ADI_CFG_CORE_TMR_EN   1u
#define ADI_CFG_CORE_TMR_COUNT   30000u
