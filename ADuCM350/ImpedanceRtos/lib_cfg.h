...
*
*               uC/LIB is provided in source form to registered licensees ONLY.
*It is
*               illegal to distribute this source code to any third party unless
*you receive
*               written permission by an authorized Micrium representative.
*Knowledge of
...
*memory library suite external
*               argument check feature :
*
*               (a) When ENABLED,      arguments received from any port
...
#define LIB_MEM_CFG_HEAP_SIZE \
  1024u /* Configure heap memory size         [see Note #2a].           */
...
*               digits to calculate &/or display for floating point string
*function(s).
*
