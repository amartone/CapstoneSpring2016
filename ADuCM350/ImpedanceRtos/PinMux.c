...
int32_t adi_initpinmux(void) {
  ...
  *((volatile uint32_t *)REG_GPIO1_GPCON) =
      LCD_S3_PORTP1_MUX | LCD_S4_PORTP1_MUX | LCD_S5_PORTP1_MUX |
      LCD_S6_PORTP1_MUX | LCD_S7_PORTP1_MUX | LCD_S8_PORTP1_MUX |
      LCD_S9_PORTP1_MUX | LCD_S10_PORTP1_MUX | LCD_S11_PORTP1_MUX |
      LCD_S12_PORTP1_MUX | LCD_S13_PORTP1_MUX | LCD_S14_PORTP1_MUX |
      LCD_S15_PORTP1_MUX | LCD_S16_PORTP1_MUX | LCD_S17_PORTP1_MUX |
      LCD_S18_PORTP1_MUX;
  *((volatile uint32_t *)REG_GPIO2_GPCON) =
      LCD_S1_PORTP2_MUX | LCD_S2_PORTP2_MUX | LCD_S19_PORTP2_MUX |
      LCD_S20_PORTP2_MUX | LCD_S21_PORTP2_MUX | LCD_S22_PORTP2_MUX |
      LCD_S23_PORTP2_MUX | LCD_S24_PORTP2_MUX | LCD_S25_PORTP2_MUX |
      LCD_S26_PORTP2_MUX | LCD_S27_PORTP2_MUX | LCD_S28_PORTP2_MUX |
      LCD_BPLANE0_PORTP2_MUX | LCD_BPLANE1_PORTP2_MUX | LCD_BPLANE2_PORTP2_MUX |
      LCD_BPLANE3_PORTP2_MUX;
  *((volatile uint32_t *)REG_GPIO3_GPCON) =
      UART0_ALT_TX_PORTP3_MUX | UART0_ALT_RX_PORTP3_MUX | LCD_S29_PORTP3_MUX |
      LCD_S30_PORTP3_MUX | LCD_S31_PORTP3_MUX | LCD_S32_PORTP3_MUX;
  return 0;
}
